    ...
    <>
      <div className="flex justify-between bg-gradient-to-bl from-slate-900 via-gray-600 to-fuchsia-900 h-24 items-center px-24 outline-double outline-3 outline-offset-2  ... ">
        ...
        {!loggedIn ? (
          ...
          <div className="flex w-1/4 items-end justify-end gap-4 text-2xl font-extrabold ...  font-robotics bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500..">
            <Link
              to="/login"
          ...
          <div className="flex w-2/4 items-end justify-end gap-4 text-2xl font-extrabold ...  font-robotics bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500..">
            <Link
              to="/Profile"
