  ...
  return (
    <>
     <div className="mt-24 w-1/2 h-96 mx-auto border border-black flex flex-col items-center justify-center align-middle gap-4 bg-gradient-to-bl from-slate-900 via-gray-600 to-fuchsia-900 h-24 items-center px-24 outline-double outline-3 outline-offset-2 ">
      ...
      <input  className="text-center border border-blue-500 black w-48 font-robotics" onChange={(e) => handleUsername(e)} value={username} placeholder="username" type="text"></input>
      <input  className="text-center border border-blue-500 black w-48 font-robotics" onChange={(e) => handlePassword(e)} value={password} placeholder="password" type="password"></input>
      <button className="text-center cursor-pointer hover:bg-blue-200 hover:text-black bg-blue-600 text-white border black w-48 font-robotics"  onClick={() => login()}>Log in</button>
